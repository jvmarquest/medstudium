...
export const OnboardingStepLayout: React.FC<OnboardingStepLayoutProps> = ({
    ...
    return (
        <div className="relative flex h-[100dvh] w-full max-w-[430px] lg:max-w-none mx-auto flex-col overflow-hidden border-x lg:border-x-0 border-slate-200 dark:border-slate-800 shadow-2xl lg:shadow-none bg-background-light dark:bg-background-dark">
