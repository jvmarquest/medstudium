  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      if (mode === View.SIGNUP) {
        ...
        // Check if session is missing, implying email verification is required
          ...
          {verificationSent ? (
            <div className="flex flex-col gap-5 mt-4">
              ...
              <button
                ...
                className="flex w-full cursor-pointer items-center justify-center overflow-hidden rounded-xl h-12 px-5 bg-primary hover:bg-blue-600 text-white text-base font-bold leading-normal tracking-[0.015em] transition-colors shadow-lg shadow-blue-900/20"
              >
                Voltar para Login
              </button>
            </div>
